...
function CardInfo({ text }: { text: string }) {
  return (
    <button type="button" className="info-trigger" title="How did we measure this?" aria-label="How did we measure this?">
...
function Tip({ children }: { children: ReactNode }) {
  return <p className="card-tip"><strong>What you can do:</strong> {children}</p>;
}
